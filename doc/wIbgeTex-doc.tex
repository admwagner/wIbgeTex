...
Nos exemplos, o código \texttt{\string,} (\textit{thin space}) gera um pequeno espaço entre os números, substituindo o ponto utilizado como separador de milhar. Em alguns casos, a vírgula foi colocada entre chaves (como em \texttt{{,}}), a fim de evitar espaço desnecessário.
...
\item \texttt{tabularx} e \texttt{longtable} (para tabelas com largura flexível ou que se estendem por mais de uma página);
...
\begin{quadroBase}[Pacotes Essenciais (Preâmbulo)]
{\footnotesize
	\begin{verbatim}
...
\begin{itemize}
\item \textbf{Fonte da Tabela:} aplica a fonte definida em \texttt{\string\wIbgeTabFont} (por padrão, \texttt{\string\sffamily\string\footnotesize}) a todos os ambientes \texttt{tabular}, \texttt{tabularx} e \texttt{longtable};
...
O pacote disponibiliza os seguintes tipos de coluna personalizados para uso nos ambientes \texttt{ctable}, \texttt{tabularx}, \texttt{tabular} e \texttt{longtable}:
...
\begin{itemize}
    ...
    \item ou após \texttt{\string\end{longtable}}, como na \wautoref{tabIbge3}.
\end{itemize}
...
\begin{itemize}
   ...
   \item  \textbf{Quebra de tabelas:} se uma tabela for extensa, ela deve ser dividida. O cabeçalho deve ser repetido em cada nova página. O \texttt{longtable} (usado na \wautoref{tabIbge3}) realiza essa operação automaticamente.
...
% --- Importa a Tabela 2 ---
\clearpage
\input{../exemplo/tabelas/tabela-02-modelo.tex}
\newpage
...
% --- Importa a Tabela 3 ---
\clearpage
\input{../exemplo/tabelas/tabela-03-modelo.tex}
\newpage
...
% --- Importa a Tabela 4 ---
\clearpage
\input{../exemplo/tabelas/tabela-04-modelo.tex}
\newpage
...
% --- Importa a Tabela 5 ---
\clearpage
\input{../exemplo/tabelas/tabela-05-modelo.tex}
\newpage
...
% --- Importa a Tabela 6 ---
\clearpage
\input{../exemplo/tabelas/tabela-06-modelo.tex}
...
% --- Importa a Tabela 7 ---
\clearpage
\input{../exemplo/tabelas/tabela-07-modelo.tex}
...
% --- Importa a Tabela 8 ---
\clearpage
\input{../exemplo/tabelas/tabela-08-modelo.tex}
\newpage
...
% --- Importa a Tabela 9 ---
\clearpage
\input{../exemplo/tabelas/tabela-09-modelo.tex}
...
% --- Importa a Tabela 10 ---
\clearpage
\input{../exemplo/tabelas/tabela-10-modelo.tex}
...
% --- Importa a Tabela 11 ---
\clearpage
\input{../exemplo/tabelas/tabela-11-modelo.tex}
...
% --- Importa a Tabela 12 ---
\clearpage
\input{../exemplo/tabelas/tabela-12-modelo.tex}
\newpage
...
% --- Importa a Tabela 13 ---
\clearpage
\input{../exemplo/tabelas/tabela-13-modelo.tex}
...
% --- Importa a Tabela 14 ---
\clearpage
\input{../exemplo/tabelas/tabela-14-modelo.tex}
...
% --- Importa a Tabela 15 ---
\clearpage
\input{../exemplo/tabelas/tabela-15-modelo.tex}
\newpage
